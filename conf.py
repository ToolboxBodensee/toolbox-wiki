...
BLOG_AUTHOR = "Toolbox"  # (translatable)
BLOG_TITLE = "Toolbox Wiki"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wiki.tbbs.me/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://wiki.tbbs.me/"
BLOG_EMAIL = "kontakt@toolbox-bodensee.de"
BLOG_DESCRIPTION = "Wiki der Toolbox Bodensee e.V."  # (translatable)
